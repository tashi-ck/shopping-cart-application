...
namespace ShoppingCart.UnitTests.Services
{
    public class UserServiceTests
    {
        ...
        {
            var profile = new Auth0ProfileDto(
                "auth0|new123",
                "new@example.com",
                "New",
                "User",
            ...
            _userRepositoryMock
                .Setup(r => r.GetByAuth0IdAsync(profile.Auth0Id))
            ...
            _userRepositoryMock.Verify(
                r => r.CreateAsync(
                    It.Is<User>(u => u.Auth0Id == profile.Auth0Id)),
                Times.Once);
        }
        ...
        public async Task GetOrCreateUserAsync_DeactivatedUser_ThrowsUnauthorized()
        {
            ...
            // A deactivated user is blocked before profile sync/update.
            _userRepositoryMock.Verify(
                r => r.UpdateProfileAsync(It.IsAny<User>()),
                Times.Never);
        }
        ...
        public async Task GetOrCreateUserAsync_ExistingUser_UnchangedProfile_DoesNotWrite()
        {
            ...
            // Nothing changed, so no database update should occur.
            _userRepositoryMock.Verify(
                r => r.UpdateProfileAsync(It.IsAny<User>()),
                Times.Never);
        }
